...
gcc -std=c89 -fsanitize=address -Wall -Wextra -Wno-unused-parameter -Wno-unused-variable -Wno-unused-but-set-variable $source_directory/linux_x_window.c -o $binary_directory/game -lxcb
